function percentage(){   
    ...
    for ( i ; i < getgrade.length ; i++) {
        ...
        if (!isNaN(percent)) {
            document.getElementsByClassName("percent")[i].innerHTML = percent.toFixed(2)+ '%';
        }
        else{
            percent = "Please insert your grade";
...
function calculteavg(){
    ...
    var avg = (totalGgrade/totalTgrade *100).toFixed(2) +"%";
    //alert(avg);
...
function calcultemean(){
    ...
    var mean =  (totalpercent/times).toFixed(2) + '%';
